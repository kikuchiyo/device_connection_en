...
For details about the configuration of a product, see [Creating a Product](/docs/device-connection/en/latest/cloud/creating_product).
...
For details about device settings, see [Creating a Device](/docs/device-connection/en/latest/cloud/creating_device).
