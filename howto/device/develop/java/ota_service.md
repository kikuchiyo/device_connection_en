...
You can use the firmware upgrade over-the-air (OTA) service to upgrade your device firmware. Use the following sample code as your reference.

The code is also available from `<dir>/blob/master/src/main/java/com/envisioniot/enos/iot_mqtt_sdk/sample/OtaSample.java`.
